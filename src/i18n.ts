...
const zhCN = {
  ...
  'otp.resend': '重新发送 OTP',
  'otp.heading': '输入验证码',
  'otp.description': '验证码已发送到绑定号码。输入 6 位 OTP 或直接粘贴收到的完整短信。',
  'otp.hint': '原型模式下除 `000000` 外的任意 6 位数字都会返回成功。',
  'otp.placeholder': '请输入 6 位验证码，或粘贴完整 OTP 短信',
  'otp.tipTitle': '校验提示',
  ...
  'toast.invalidOtp': '请输入验证码或粘贴 OTP 短信。',
...
const enUS = {
  ...
  'otp.description': 'The code has been sent to the linked number. Enter the 6-digit OTP or paste the full SMS.',
  'otp.hint': 'In prototype mode, any 6-digit code except `000000` returns success.',
  'otp.placeholder': 'Enter 6-digit code or paste full OTP SMS',
  ...
  'toast.invalidOtp': 'Enter OTP or paste the SMS.',
